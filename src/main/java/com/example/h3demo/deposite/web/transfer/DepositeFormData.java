package com.example.h3demo.deposite.web.transfer;

import java.util.Objects;

public class DepositeFormData {
	...
	public DepositeFormData(String txcode, String routing_page, String in, String out, String id, String name,
			String company) {
		super();
		this.txcode = txcode;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DepositeFormData other = (DepositeFormData) obj;
