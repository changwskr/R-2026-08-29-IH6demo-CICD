...
public class MBAIO11005DTO {
	...
	public MBAIO11005DTO() {
		super();
		// TODO Auto-generated constructor stub
	}


	public MBAIO11005DTO(String in, String out) {
		this.in = in;
		this.out = out;
	}


	public MBAIO11005DTO(String txcode, String routing_page, String in, String out, String id) {
		super();
		this.txcode = txcode;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MBAIO11005DTO other = (MBAIO11005DTO) obj;
	...
	public String toString() {
		return "IO11005DTO [txcode=" + txcode + ", routing_page=" + routing_page + ", in=" + in + ", out=" + out + ", id="
