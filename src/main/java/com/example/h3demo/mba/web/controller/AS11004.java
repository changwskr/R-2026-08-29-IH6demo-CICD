 ...
 */
@Controller
public class AS11004 {
	
	/**
	 * (요청) http://127.0.0.1:8080/11004?IOin=kkkkkjjjjaaaaaaaaaaaaaaaaaffffffff3333333
	 * (응답) JSON 타입으로 리턴한다.
	 * {
		    "txcode": "11002",
		    "routing_page": "11002",
		    "in": "kkkkkjjjjaaaaaaaaaaaaaaaaaffffffff3333333",
		    "out": "IO11002 [txcode=11002, routing_page=11002, in=kkkkkjjjjaaaaaaaaaaaaaaaaaffffffff3333333, out=kkkkkjjjjaaaaaaaaaaaaaaaaaffffffff3333333, id=333, name=roian, company=sk]",
		    "id": "333",
		    "name": "roian",
		    "company": "sk"
		}
    ...
    @GetMapping("11004")
    @ResponseBody
    public Object execute(@RequestParam("IOin") String IOin, Model model){
        ...
        return ioarea; //템플릿을 찾지 않고 그대로 API 방식으로 클라이언트로 내려간다.
