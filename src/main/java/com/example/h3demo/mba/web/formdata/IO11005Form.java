package com.example.h3demo.mba.web.formdata;

import java.util.Objects;

public class IO11005Form {
	...
	public IO11005Form(String txcode, String routing_page, String in, String out, String id, String name,
			String company) {
		super();
		this.txcode = txcode;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IO11005Form other = (IO11005Form) obj;
	...
	public String toString() {
		return "IO11005Form [txcode=" + txcode + ", routing_page=" + routing_page + ", in=" + in + ", out=" + out + ", id="
