...
import com.example.h3demo.mba.web.formdata.IO11007Form;
import com.example.h3demo.mba.business.as.MBA11007AS;
 ...
 */
@Controller
public class MBC11007CTL {
	
    private final MBA11007AS as;

    @Autowired
    public MBC11007CTL(MBA11007AS pvAS11007) {
        this.as = pvAS11007;
     ...
     * @return
     */
    @PostMapping("/post/11007")
    public Object execute(IO11007Form form, Model model){
    ...
    public String create(IO11007Form form) {
    ...
    public String list(Model model){
    	List<MBAIO11007DTO> members = as.findMembers();    	
