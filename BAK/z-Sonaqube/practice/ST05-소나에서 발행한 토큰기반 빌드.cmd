...
mvn sonar:sonar -Dsonar.host.url=http://192.168.0.8:9000 -Dsonar.login=squ_25b77363d5ad57caffe56fe39bf3e28c9b3795ee
소나빌더를 통해서 정적분석 작업을 한다.

(윈도우에서 직접실행 필요)
C:\Programming(23-08-15)\MyProject-Inteli\IH6demo-2025-08-03>mvn sonar:sonar -Dsonar.host.url=http://192.168.0.8:9000 -Dsonar.login=squ_25b77363d5ad57caffe56fe39bf3e28c9b3795ee
